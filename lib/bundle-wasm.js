...
import {decode} from 'https://esm.sh/@webassemblyjs/wasm-parser';
import {print} from 'https://esm.sh/@webassemblyjs/wast-printer';
import {
  traverse,
  isNumberLiteral,
  identifier,
...
} from 'https://esm.sh/@webassemblyjs/ast';
import {parse} from 'https://esm.sh/@webassemblyjs/wast-parser';
let wabt;
